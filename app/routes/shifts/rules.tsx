...
export default function ShiftRules() {
  ...
  useEffect(() => {
    fetchShiftRuleDefinitionListing();
  }, []);

  const fetchShiftRuleDefinitionListing = async () => {
    try {
      setIsLoading(true);
      setLoadError(null);
      const data = {
        tableDataEnum: dynamicTableEnum.ShiftRules,
        apiParams: "",
      };
      ...
      console.log("Error fetching shift rules:", error);
      const errorMessage =
  ...
  const filteredRules = shiftRules.filter((rule: ShiftRule) => {
  ...
  const handleItemPress = (item: ShiftRule) => {
    navigate(`/shifts/rules/${item.code}`);
  };
      ...
      <div className="p-8">
        <div className="flex items-center justify-center min-h-[400px] bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="text-center">
            ...
            <button
              type="button"
              onClick={fetchShiftRuleDefinitionListing}
    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Manage shift rule definitions and configurations
        </p>
      </div>
          ...
          {filteredRules.map((item, index) => (
            ...
            >
              <div className="flex items-center">
                ...
                <div
                  className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-base mr-3"
