...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Roster App - Dashboard" },
    { name: "description", content: "Roster Management System" },
  ];
}
  ...
  const cards = [
    {
      ...
      description: 'View and manage employee rosters, schedules, and assignments',
      href: '/roster/view',
      icon: (
    ...
    },
    {
      ...
      description: 'Manage employee records, schedules, and career information',
      href: '/employees',
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Configure shift definitions, rules, and groupings',
      href: '/shifts/definitions',
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Create and manage schedule definitions and work rules',
      href: '/schedules',
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Generate reports and view roster analytics',
      href: '/reports',
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Welcome to your Roster Management System</p>
      </div>
          ...
          {cards.map((card) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`w-14 h-14 ${card.color} rounded-lg flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform duration-200`}>
                  {card.icon}
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { action: 'Schedule updated', time: '4 hours ago', icon: '📅' },
            { action: 'Shift definition created', time: '1 day ago', icon: '🕐' },
            { action: 'Report generated', time: '2 days ago', icon: '📊' },
          ].map((activity, index) => (
